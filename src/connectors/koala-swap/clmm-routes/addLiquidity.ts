...
import { getKoalaSwapV3NftManagerAddress, POSITION_MANAGER_ABI, ERC20_ABI } from '../koala-swap.contracts';
import { formatTokenAmount } from '../koala-swap.utils';
import { KoalaSwapClmmAddLiquidityRequest } from '../schemas';
...
export const addLiquidityRoute: FastifyPluginAsync = async (fastify) => {
  fastify.post<{
    Body: Static<typeof KoalaSwapClmmAddLiquidityRequest>;
    Reply: AddLiquidityResponseType;
  }>(
    '/add-liquidity',
    {
      schema: {
        description: 'Add liquidity to an existing KoalaSwap V3 position',
        tags: ['/connector/koala-swap'],
        body: KoalaSwapClmmAddLiquidityRequest,
        response: {
