...
export const koalaSwapClmmRoutes: FastifyPluginAsync = async (fastify) => {
  await fastify.register(poolInfoRoute);
  // Additional routes will be registered as they are implemented
...
export default koalaSwapClmmRoutes;
